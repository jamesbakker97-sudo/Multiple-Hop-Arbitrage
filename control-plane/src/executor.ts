...
export class ExecutorClient {
  ...
  private async estimateArbitrumL1CalldataGas(tx: { to: string; from: string; data: string }, l2GasEstimate: bigint): Promise<bigint> {
  ...
  private estimatedNetProfitWei(record: ExecutionRecord, txCostWei: bigint): bigint {
