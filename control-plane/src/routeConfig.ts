...
import { z } from "zod";
import type { ExecutionRouteConfig } from "./types.js";
...
const executionRouteSchema = z.array(
  z.object({
    cycleId: z.string(),
...
export async function loadRouteConfig(path: string): Promise<ExecutionRouteConfig[]> {
